...
from modeling_FOREcasT import FOREcasTConfig, FOREcasTModel
from pipeline_FOREcasT import FOREcasTPipeline
...
api.upload_file(
    ...
    path_or_fileobj="FOREcasT/pipeline_FOREcasT.py",
    path_in_repo="pipeline_FOREcasT.py"
)
api.upload_folder(
    repo_id=f"ljw20180420/{args.data_name}_{FOREcasTConfig.model_type}",
