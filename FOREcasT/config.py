...
parser_train.add_argument("--reg_const", type=float, default=0.01, help="regularization coefficient for deletion")
parser_train.add_argument("--i1_reg_const", type=float, default=0.01, help="regularization coefficient for insertion")
