...
parser_dataset.add_argument("--data_path", type=str, default="ljw20180420/CRISPRdata", help="data path")
parser_dataset.add_argument("--data_name", type=str, default="SX_spcas9_inDelphi", help="data name")
